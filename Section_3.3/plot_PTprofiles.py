...
params= np.array([-0.6 , -0.4 ,  0.0  ,  0.0  ,  1.09,  -1.07,   -1.168,   1.784,  -1.7495  ])
logfile='./4species_4opac_uniform/MCMC.log'
stepsize= np.array([ 0.01,  0.01,  0.0  ,  0.0  ,  0.01,  0.01,  0.01,  0.01,  0.01])
MCMCdata= './4species_4opac_uniform/output.npy'
...
plt.savefig('4mol-PT.png')
plt.savefig('4mol-PT.ps')
