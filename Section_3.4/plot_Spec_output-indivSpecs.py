...
# CO2
low, high = 1e-12, 1e-8
xtic = [1e-11, 1e-10, 1e-9] 
xlab = ["10$^{-11}$", "10$^{-10}$", "10$^{-9}$"]
...
# CH4
low, high = 1e-11, 1e-7
xtic = [1e-10, 1e-9, 1e-8] 
xlab = ["10$^{-10}$", "10$^{-9}$", "10$^{-8}$"]
...
xtic = [1e-7, 1e-6, 1e-5] 
xlab = ["10$^{-7}$","10$^{-6}$", "10$^{-5}$"]
outflux = 'NH3-ExoMol-1e100-flux.dat'
plot_bestFit_Spectrum(low, high, xtic, xlab, 'NH3', 'firebrick', '$NH_3$', atmfile, filters, kurucz, tep_name, outflux, data, uncert, direct)
...
xtic = [1e-3, 1e-2, 1e-1] 
xlab = ["10$^{-3}$", "10$^{-2}$", "10$^{-1}$"]
outflux = 'HCN-ExoMol-1e100-flux.dat'
plot_bestFit_Spectrum(low, high, xtic, xlab, 'HCN', 'darkgreen', '$HCN$', atmfile, filters, kurucz, tep_name, outflux, data, uncert, direct)
...
xtic = [1e-11, 1e-10, 1e-9] 
xlab = ["10$^{-11}$", "10$^{-10}$","10$^{-9}$"]
outflux = 'C2H2-ExoMol-1e100-flux.dat'
plot_bestFit_Spectrum(low, high, xtic, xlab, 'C2H2', 'palevioletred', '$C_2H_2$', atmfile, filters, kurucz, tep_name, outflux, data, uncert, direct)
